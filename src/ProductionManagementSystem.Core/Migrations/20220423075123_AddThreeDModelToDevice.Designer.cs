...
namespace ProductionManagementSystem.Core.Migrations
{
    ...
    [Migration("20220423075123_AddThreeDModelToDevice")]
    partial class AddThreeDModelToDevice
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductionManagementSystem.Core.Models.PCB.EntityInPcb", b =>
                {
                    b.HasOne("ProductionManagementSystem.Core.Models.PCB.Pcb", "Pcb")
                        .WithMany("Entities")
                        .HasForeignKey("PcbId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
