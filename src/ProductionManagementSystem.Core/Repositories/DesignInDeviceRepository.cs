...
namespace ProductionManagementSystem.Core.Repositories
{
    ...
    public class DesignInDeviceRepository : Repository<DesignInDevice>, IDesignInDeviceRepository
    {
        ...
        public override async Task<List<DesignInDevice>> GetAllAsync()
        {
        ...
        public override async Task<List<DesignInDevice>> FindAsync(Func<DesignInDevice, bool> predicate, string includeProperty=null)
        {
